...
Today a block is "probably final" once 21 delegates have built on it - a full round (168 s). [PQ Nodes](https://github.com/smartholdem/sth-core-pq) already roll back
