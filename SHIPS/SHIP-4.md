...
block to all [PQ Nodes](https://github.com/smartholdem/sth-core-pq): 60–150ms versus 1–3 s over legacy WebSockets.
...
`Peers` gossip -> legacy gateways announced by [PQ Node](https://github.com/smartholdem/sth-core-pq) ([SHIP-5.md](SHIP-5.md)). A node that has ever been online can restart with
...
Additive. [PQ Node](https://github.com/smartholdem/sth-core-pq) speak both stacks ([SHIP-5.md](SHIP-5.md)); legacy nodes see PQ nodes as ordinary WebSocket peers.
